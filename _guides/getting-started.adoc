...
We recommend continuing the journey with the link:building-native-image[building a native executable guide], where you learn about native executable creation and packaging the application in a container.
